(function(){
    ...
    angular
        ...
        .controller("PriceAnalyticsCtrl",["$scope","products","productService","$filter",PriceAnalyticsCtrl]); //name , array of dependancies and controller reference function | "products" is the function reference of the productResource in the resolve value
